...
osgText::Font* fontHei = osgText::readFontFile("times.ttf");
osgText::Font* fontKai = osgText::readFontFile("times.ttf");
...
geode->addDrawable(osg::createTexturedQuadGeometry(osg::Vec3(-150.0,1.0,-130.0),osg::Vec3(300.0,0.0,0.0),osg::Vec3(0.0,0.0,200.0),1.0,1.0));
