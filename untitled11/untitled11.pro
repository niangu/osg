...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../lib/release/ -losgText
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../lib/debug/ -losgText
else:unix: LIBS += -L$$PWD/../lib/ -losgText
